...
POSTPATH="${BINPATH}/_preposts"
DIST_FOLDER="$POSTPATH"

# Set your blog URL
BLOG_URL="aliriolau.github.io/alirio.blog"
...
echo "[comment]: <> (文章简介，列表页显示)"
echo "introduction:"
#echo "[comment]: <> - tagName"
#echo "tag:"
echo "[comment]: <> [tagName1, tagName2] (搜索key)"
echo "tags: []"
echo "layout: post"
echo "project: false"
echo "[comment]: <> image url"
echo "feature: "
echo "comments: true"
echo "---"
